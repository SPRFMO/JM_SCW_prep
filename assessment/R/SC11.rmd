...
Annoted data files can be found in the Excel spreadsheet `SC11_datfiles.xlsx` on [`jjm/assessment/data`](https://github.com/SPRFMO/jjm/tree/master/assessment/data).
...
1.00    | As 0.09 but with updated model (selectivity changes, recruitment) to 2023; 0.09 data file
-----------|--------------
