...
The code used to run the following sensitivities can be found in `assessment/R/SC11.R`.

- Re-run 0.05 onwards with updated catch projections for Chile (80,466 t for Fleet 1 and 736,292 t for Fleet 2; Ignacio Paya 30/08/23) and Peru (210,000 t; Ana Alegre 01/09/23)
- Acoustic Central South data obtained (Ignacio Paya 10/09/23)
- 
- Effort creep sensitivity has already been done in SC11-JM06_corrected
...
# Other Business
## General
- No 2022 Chile AcousN index value
