...
The code to create the input files for this assessment and to run these models can be found in [`jjm/assessment/R/SC10_Bridging.R`](https://github.com/SPRFMO/jjm/tree/master/assessment/R/SC10_Bridging.R). Should you choose to run the models, please ensure that you have:
