...
### Single-stock hypothesis {.tabset}
#### Biomass
```{r, fig.cap=paste0("Plot comparing biomass estimates from adding flexibility to selectivity and catchability for the offshore fishery in 2021.")}
hyp <- "h1"
...
#### Recruitment
```{r, fig.cap=paste0("Plot comparing recruitment estimates from adding flexibility to selectivity and catchability for the offshore fishery in 2021.")}
plot(res,combine=T,what="recruitment",stack=F,main="Recruitment")
```

#### Fishing Mortality
```{r, fig.cap=paste0("Plot comparing fishing mortality estimates from adding flexibility to selectivity and catchability for the offshore fishery in 2021.")}
...
This was also run as a sensitivity in SC11 (SC11-1.05).
...
### Single-stock hypothesis {.tabset}
#### Biomass
```{r, fig.cap=paste0("Plot comparing biomass estimates from updating the Chilean CPUE index to that from SC12-JM06.")}
...
Model `r finmodname` was selected as the final model for `r format(Sys.time(), "%Y")`. **NOT YET DONE**
...
# Other Business
## Data needs
- Standardise data reporting workflow for updating Peruvian weight at age
- Aging protocol for acoustic survey
  - Age-0 fish showing up even though survey conducted in March
