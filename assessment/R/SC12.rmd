...
```{r biomass_h1_0.00 , fig.cap=paste0("Plot comparing biomass estimated by last year's model (", names(mod_prev_h1), ") with a re-run of the model this year (", names(mod0.00),").")}

oldnewMods <- combineModels(mod0.00, mod_prev_h1) %>%
...
### Recruitment
```{r recruit_h1_0.00, fig.cap=paste0("Plot comparing recruitment estimated by last year's model (", names(mod_prev_h1), ") with a re-run of the model this year (", names(mod0.00),").")}

plot(oldnewMods,combine=T,what="recruitment",stack=F,main="Recruitment")
```

### Fishing Mortality
```{r fmort_h1_0.00, fig.cap=paste0("Plot comparing fishing mortality estimated by last year's model (", names(mod_prev_h1), ") with a re-run of the model this year (", names(mod0.00),").")}
...
```{r biomass_h2_0.00 , fig.cap=paste0("Plot comparing biomass estimated by last year's model (", names(mod_prev_h2), ") with a re-run of the model this year (", names(mod0.00),").")}

oldnewMods <- combineModels(mod0.00,mod_prev_h2) %>%
...
### Recruitment
```{r recruit_h2_0.00, fig.cap=paste0("Plot comparing recruitment estimated by last year's model (", names(mod_prev_h2), ") with a re-run of the model this year (", names(mod0.00),").")}
...
### Fishing Mortality
```{r fmort_h2_0.00, fig.cap=paste0("Plot comparing fishing mortality estimated by last year's model (", names(mod_prev_h2), ") with a re-run of the model this year (", names(mod0.00),").")}
...
Projections done under a conservative recruitment regime (steepness 0.65, recruitment curve estimated from `(h1_mod[[1]]$data$year[2]-16):(h1_mod[[1]]$data$year[2]-2)`).
...
# Other Business
## Data needs
- Catch totals for Chile different in ALK relative to annex 1 of SC12-JM03

## General
- h2 MSY estimates are still strange, but worked for Windows OS in 2023?
- Linking selectivity to cohort strength when calculating FMSY; instead of using the last year's selectivity with the most recent cohort strengths
  - Tom has model that adds one extra parameter to track cohort strength and selectivity to address targeting of different age classes for projections
