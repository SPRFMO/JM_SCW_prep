...
knitr::opts_knit$set(root.dir=here::here("assessment"))
...
The data updated to `r as.numeric(format(Sys.time(), "%Y"))-1`, includes catch estimates, age and length compositions, and indices of abundance. **Note that Offshore CPUE hasn't been updated yet, so 0.04 doesn't reflect any changes.**
...
### Summary Plot
```{r, fig.cap=paste0("BMSY fixed at ", round(new_bmsy_s)/1000, " million tons for the south stock and ", round(new_bmsy_n)/1000, ", shown as the orange line. The blue lines show the reference points estimated by the model.")}
...
## Data needs
- 2023 offshore CPUE
- 2024 age composition and weight at age for offshore fleet
- Updated 2024 total catch estimates
