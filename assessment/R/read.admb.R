...
#' read.rep
#' 
#' @return list from admb report file
#' 
#' @export
#' 
...
#' read.dat
#' 
#' @return list from admb data file
#' 
#' @export
#' 
...
#' read.psv 
#'
#' @param fn filename of binary parameter file to read
#'
#' @return mcmc matrix of parameter values
#' @export
#'
read.psv <-
