...
modls  <- runit(geth(paste0(finmodname,".ls"),c("h1","h2")),parallel=TRUE,pdf=F,portrait=F,est=T,exec="../src/jjm", adflags=paste0("-tac ", tac_new, " -fut_sel 3"))
...
report(h1_ls_msy, format="word", output="risk_tables/", Fmult=c(0, .75, 1, 1.25, "FMSY", "FTAC 1.15"))
report(h1_ls_msy, format="pdf",  output="risk_tables/", Fmult=c(0, .75, 1, 1.25, "FMSY", "FTAC 1.15"))
...
report(h2_ls_msy, format="word", output="risk_tables/", Fmult=c(0, .75, 1, 1.25, "FMSY", "FTAC 1.15"))
