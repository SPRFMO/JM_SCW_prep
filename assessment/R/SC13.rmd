...
tab_catch <- catch %>%
  ...
  kable() %>%
  kable_styling() %>%
  row_spec(4, bold = TRUE, background = "#1268b9", color = "white") %>%
  row_spec(5, bold = TRUE, background = "#05427b", color = "white")
...
##### Catch
```{r}
plot(h1_diag_ls, var = "catchPrediction", scenarios=c(0, .75, 1, 1.25, "FMSY", "FTAC 1.15"))
```
