---
title: "Comparison of mod0.14, mod1.1, mod1.2, and mod2.1"
date: today
format:
  html:
    toc: true
...
models <- c("mod0.14", "mod1.1", "mod1.2", "mod2.1")
...
```{=html}
<div class="paper-title">Comparison of mod0.14, mod1.1, mod1.2, and mod2.1</div>
```
