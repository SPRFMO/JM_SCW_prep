...
biomass estimate had declined from more than 3 million t in 2025 to just over
0.64 million t in 2026. Members also noted that the Chilean fleet's
year-to-date catch was about 30% of the comparable catch level from the previous
year. The Chair requested that members provide their best estimate of the most
likely 2026 catch so that at least some indication of the apparent stock trend
could be relayed before the MSE meeting and Scientific Committee review. Part
...
diagnostic performance favourable for assessment use. Niels was asked to update
the report text describing these retrospective results.
...
Chile initially indicated interest in presenting an updated Chile Acoustic
South-Central option, but that request was later withdrawn. The practical
proposal carried forward was to retain the series as currently configured unless
a later sensitivity is requested.
...
given the strong mandate to have an MSE ready during 2026.
...
- **Noted** that the new Chilean CPUE treatment begins in 1998, includes the
  ...
  coverage with INLA standard errors.
- **Noted** that the 2026 Chile acoustic survey and year-to-date fishery
  information indicate exceptional recent conditions, including apparent
