...
also discussed the distinction between model-based indicators for CPUE and
design-based indicators for surveys. The Day 3 decision was to retain the raw or
...
entire time series. After extensive discussion, the members agreed
to proceed with Chile's proposal and apply a 1% compounded increase creep
...
Chair noted that it could be raised again at SC but should not have a large effect
on making progress with the MSE.

The technical rationale supporting this methodological update is grounded in
both empirical data and historical fleet dynamics. First, this approach directly
incorporates operational feedback from the Chilean SC fleet captains, who
identified 2005 as an inflection point for changes in fishing efficiency.
Second, acknowledging this shift, the majority of members concurred that
applying a continuously increasing efficiency correction after that period is
largely unnecessary. Finally, retaining the 1% factor prior to 2005 effectively
anchors the earlier time series, avoiding the substantial jump in historical
efficiency that was the primary concern with the initial proposal.
...
a larger share of the quota since 2019. The Day 3 discussion agreed that the new
Peruvian CPUE series starts later than the historical assessment CPUE treatment
and should replace the previous Peru CPUE index rather than be appended to it in
the base model. The previous Peru CPUE index should therefore be removed from the
base configuration.
