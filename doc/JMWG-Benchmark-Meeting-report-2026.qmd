...
The following requests were identified during the Day 2 CPUE and data-quality
session and should be tracked separately from general discussion notes.

| Request | Requested product | Lead / source | Purpose |
|---|---|---|---|
| Catch/fishery data workflow statement | Draft a paragraph explaining the JMWG's compressed data schedule, the current template-based submission routine, and why database development alone will not resolve near-term benchmark data needs. | Data-quality subgroup / Chair / Secretariat | Document why the current workflow is used and what should be improved without disrupting immediate assessment preparation. |
| Post data-quality checks | Post the catch and fishery data quality-check material to the `jjmData` GitHub repository. | Data-quality subgroup | Make diagnostics and checks visible to members working on assessment inputs. |
| Clarify sampling and ALK sample sizes | Investigate reported sample sizes in age-length-key and composition data, including discrepancies between numbers of ages and numbers of length measurements. | Data-quality subgroup / Members | Improve interpretation of sample size, coverage, and uncertainty in composition inputs. |
| Effort-creep diagnostic run | Run an assessment configuration with no creep correction but with a catchability step change in 2005. | Assessment subgroup / Chile CPUE contributors | Test whether the model estimates a large catchability shift without directly imposing the effort-creep correction. |
| Chile CPUE early-period explanation | Provide a clear explanation for why the new set-based CPUE series gives lower CPUE in earlier years with high catches than the current trip-based assessment index. | Chile CPUE contributors | Support any defensible recommendation to replace, supplement, or retain the current Chile CPUE index. |
| Chile CPUE set coverage | Add number and proportion of sets by year to the CPUE data-summary table. | Chile CPUE contributors | Document representativeness and low early-period coverage. |
| Chile CPUE model-comparison summary | Summarize the `sdmTMB` and INLA model-comparison discussion, including year-effect treatment, mesh sensitivity, northern fishing activity, and annual uncertainty. | Sebastian / Ignacio / Niels | Provide report-ready text for deciding whether a new Chile CPUE index can be used in the assessment. |
| Days-at-sea coefficient check | Check the strength and interpretation of the days-at-sea or DFP coefficient in the INLA-based CPUE analysis. | Sebastian / Chile CPUE contributors | Determine whether this covariate reflects fishing effort, spatial availability, or movement effects that could bias the abundance signal. |
| True-zero CPUE records | Check whether zero CPUE records are true fishing zeroes or technical/non-fishing records, and whether they should be included in the CPUE standardization. | Chile CPUE contributors | Decide whether positive-only models are adequate or whether zero-inflated/delta treatment should be evaluated. |
| Peru CPUE full-series evaluation | Extend and evaluate the Peru CPUE time series before using it as an assessment or MSE input. | Peru CPUE contributors / Assessment subgroup | Avoid adopting a truncated recent series before its relationship to the historical series can be evaluated. |
| Peru CPUE year-interaction diagnostic | Provide the smoother or effect plot for the year interaction in the Peru CPUE model. | Peru CPUE contributors | Help evaluate whether spatial or fleet changes are being absorbed by model smoothers. |
| Offshore CPUE catchability treatment | Document the rationale for the 2021 offshore catchability break and the interpretation of El Nino effects relative to annual effects. | Offshore CPUE contributor / Assessment subgroup | Clarify whether offshore CPUE changes represent abundance, catchability, availability, or environmental effects. |
:::
