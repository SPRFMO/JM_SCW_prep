...
| 4 | Retain a sensitivity with piecemeal use of the old Chilean CPUE before 1998. | Chile CPUE sensitivity | Add to the candidate sensitivity-run list. | TBD |
| 5 | Use the new Peruvian CPUE series as a later-starting replacement and remove the previous Peru CPUE index. | Peru CPUE | Implement the replacement in the base model. | 0.02 |
...
| 7 | Increase the plus group for the Peruvian length-frequency and growth treatment. | Peru biology / composition | Specify the plus-group age in the candidate model configuration. | Complete |
