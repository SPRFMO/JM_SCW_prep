...
1.00     | 	Update model (selectivity changes, recruitment) to 2020; 0.11 data file
-----------|--------------
...
prev_env <- new.env()
load("results/mod_prev_h1.Rdat", envir = prev_env)
mod_prev <- prev_env$mod_prev_h1
...
prev_env <- new.env()
load("results/mod_prev_h2.Rdat", envir = prev_env)
mod_prev <- prev_env$mod_prev_h2
